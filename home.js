...
// Creates a new 'main' state that will contain the game
   ...
   // }
	...
	function gameOverScreen(){
		...
		plane = game.add.sprite((innerWidth/1.85),230,'player');
		plane.width = 80;
		plane.anchor.set(0.5,0.5);
		
		restartText = game.add.bitmapText((innerWidth/3), 430, "SFComic", "Touch anywhere to play again", 24);
		
		gameOverScore = game.add.bitmapText((innerWidth/3), 280, "SFComic", "Your Score: "+score, 36);
		bestScore = game.add.bitmapText((innerWidth/2.5), 330, "SFComic", "Best Score: "+topScore, 24);
